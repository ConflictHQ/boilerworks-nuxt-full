...
case "${1:-help}" in
    up|start)
        ...
        sleep 5
        compose exec -T nuxt-app npx drizzle-kit push 2>&1 | tail -3
        echo ""
    ...
    logs)
        ...
        ;;
    seed)
        compose exec -T nuxt-app npx drizzle-kit push
    ...
    help|*)
        ...
        echo "  dev           Start Nuxt dev server (local)"
